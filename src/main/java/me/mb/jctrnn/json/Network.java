...
public class Network {
	...
	public static class ParamRange {
		...
		public static class Range {
			...
			public me.mb.jctrnn.layout.Range toLayoutRange() {
				return new me.mb.jctrnn.layout.Range( low, high );
			}
		}
	}
	...
	public CTRNNLayout getLayout() throws JSONNetworkParseError {
		...
		for ( Layer layer : this.layers ) {
			for ( Neuron jsonNeuron : layer.neurons ) {
				me.mb.jctrnn.layout.Neuron layoutNeuron = new me.mb.jctrnn.layout.Neuron( nNeurons );
